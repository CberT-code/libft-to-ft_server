...
let s:l = 82 - ((17 * winheight(0) + 34) / 68)
...
wincmd w
argglobal
if bufexists("display_map.c") | buffer display_map.c | else | edit display_map.c | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 49 - ((42 * winheight(0) + 34) / 68)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
49
...
wincmd w
argglobal
if bufexists("main_test.c") | buffer main_test.c | else | edit main_test.c | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 109 - ((51 * winheight(0) + 34) / 68)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
109
...
tabnext 1
badd +0 main_test.c
badd +79 display_map.c
badd +0 cub3d.h
badd +91 parsing/parsing.c

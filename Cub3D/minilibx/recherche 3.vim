...
argglobal
%argdel
$argadd mlx_new_image.m
edit mlx_new_window.m
...
let s:l = 736 - ((0 * winheight(0) + 40) / 81)
...
wincmd w
argglobal
if bufexists("mlx_int.h") | buffer mlx_int.h | else | edit mlx_int.h | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 59 - ((55 * winheight(0) + 40) / 81)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
59
...
wincmd w
argglobal
if bufexists("mlx_new_image.m") | buffer mlx_new_image.m | else | edit mlx_new_image.m | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 28 - ((27 * winheight(0) + 40) / 81)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
28
...
exe 'vert 3resize ' . ((&columns * 120 + 182) / 364)
tabnext 1
badd +0 mlx_new_image.m
badd +149 mlx.h
badd +1 mlx_int.h
badd +1 mlx_opengl.h
badd +9 mlx_new_window.h
badd +0 mlx_xpm.c
badd +4 mlx_png.h
badd +763 mlx_rgb.c
badd +0 mlx_new_window.m
